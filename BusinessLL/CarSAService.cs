...
namespace BLL
{
    public class CarSAService
    {
        public List<string> CarAss(string CarStatus, string Upholstery, string Vents, string StuckCondition, string ParkPlace)
        {
            ...
            {
                result.Add("Due to new car materials, the concentration of TVOCs levels are high inside your car.");
                if (Vents.Equals("Yes"))
                {
                ...
                {
                    result.Add("Opening your AC vent helps your car to breathe in fresh air and get rid of TVOCs from new material in your car. Just remember to close it back when going past outdoor pollution or if in traffic.");
                }
